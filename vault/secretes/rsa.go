...
func SignParamsWithRSA(data string, privateKey *rsa.PrivateKey) (string, error) {
...
func DecryptWithRSA(base64Data string, privateKey *rsa.PrivateKey) ([]byte, error) {
...
func DecryptWithOAEP(base64Data string, privateKey *rsa.PrivateKey) ([]byte, error) {
	data, err := base64.StdEncoding.DecodeString(base64Data)
	if err != nil {
		return nil, err
	}
