...
var ERC20SafeMetaData = &bind.MetaData{
	ABI: "[{\"inputs\":[{\"internalType\":\"address\",\"name\":\"tokenAddress\",\"type\":\"address\"},{\"internalType\":\"address\",\"name\":\"owner\",\"type\":\"address\"},{\"internalType\":\"uint256\",\"name\":\"amount\",\"type\":\"uint256\"}],\"name\":\"fundERC20\",\"outputs\":[],\"stateMutability\":\"nonpayable\",\"type\":\"function\"},{\"inputs\":[{\"internalType\":\"address\",\"name\":\"tokenAddress\",\"type\":\"address\"},{\"internalType\":\"address\",\"name\":\"owner\",\"type\":\"address\"},{\"internalType\":\"address\",\"name\":\"recipient\",\"type\":\"address\"},{\"internalType\":\"uint256\",\"name\":\"amount\",\"type\":\"uint256\"}],\"name\":\"transferFromERC20\",\"outputs\":[],\"stateMutability\":\"nonpayable\",\"type\":\"function\"}]",
	Bin: "",
}
...
func (_ERC20Safe *ERC20SafeTransactor) TransferFromERC20(opts *bind.TransactOpts, tokenAddress common.Address, owner common.Address, recipient common.Address, amount *big.Int) (*types.Transaction, error) {
	return _ERC20Safe.contract.Transact(opts, "transferFromERC20", tokenAddress, owner, recipient, amount)
}

// TransferFromERC20 is a paid mutator transaction binding the contract method 0xdd71105d.
//
// Solidity: function transferFromERC20(address tokenAddress, address owner, address recipient, uint256 amount) returns()
func (_ERC20Safe *ERC20SafeSession) TransferFromERC20(tokenAddress common.Address, owner common.Address, recipient common.Address, amount *big.Int) (*types.Transaction, error) {
	return _ERC20Safe.Contract.TransferFromERC20(&_ERC20Safe.TransactOpts, tokenAddress, owner, recipient, amount)
}

// TransferFromERC20 is a paid mutator transaction binding the contract method 0xdd71105d.
//
// Solidity: function transferFromERC20(address tokenAddress, address owner, address recipient, uint256 amount) returns()
func (_ERC20Safe *ERC20SafeTransactorSession) TransferFromERC20(tokenAddress common.Address, owner common.Address, recipient common.Address, amount *big.Int) (*types.Transaction, error) {
	return _ERC20Safe.Contract.TransferFromERC20(&_ERC20Safe.TransactOpts, tokenAddress, owner, recipient, amount)
}
